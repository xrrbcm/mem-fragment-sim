...
const BOARDS=[
  ...
  {name:"Spiral Descent",difficulty:"Normal",
   entry:{row:0,col:0,dir:"N"},exit:{row:2,col:0,dir:"W"},
   path:[[0,0],[0,1],[0,2],[0,3],[1,3],[2,3],[3,3],[3,2],[3,1],[3,0],[2,0],[1,0],[1,1],[1,2],[2,2],[2,1]],
   desc:"Clockwise spiral inward. N of R1C1 → W of R3C1."},
